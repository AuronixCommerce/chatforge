          ...
          <div className="mx-auto mt-10 grid max-w-sm grid-cols-1 gap-8 lg:max-w-5xl lg:grid-cols-3">
            <Card className="flex flex-col justify-between rounded-lg border shadow-lg">
                ...
                <CardContent className="text-center space-y-4">
                    ...
                    <ul className="grid gap-2 text-muted-foreground text-left">
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-primary" /><span>1 Chatbot</span></li>
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-primary" /><span>1,000 Messages/Month</span></li>
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-primary" /><span>Community Support</span></li>
                    </ul>
                </CardContent>
                <div className="p-6">
            ...
            <Card className="flex flex-col justify-between rounded-lg border-2 border-primary shadow-lg shadow-primary/20">
                ...
                <CardContent className="text-center space-y-4">
                    ...
                    <ul className="grid gap-2 text-muted-foreground text-left">
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-primary" /><span>10 Chatbots</span></li>
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-primary" /><span>50,000 Messages/Month</span></li>
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-primary" /><span>Email & Chat Support</span></li>
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-primary" /><span>Analytics Dashboard</span></li>
                    </ul>
                </CardContent>
                 <div className="p-6">
             ...
             <Card className="flex flex-col justify-between rounded-lg border shadow-lg">
                ...
                <CardContent className="text-center space-y-4">
                    ...
                    <ul className="grid gap-2 text-muted-foreground text-left">
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-primary" /><span>Unlimited Chatbots</span></li>
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-primary" /><span>Custom Message Quotas</span></li>
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-primary" /><span>24/7 Priority Support</span></li>
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-primary" /><span>Custom Integrations</span></li>
                    </ul>
                </CardContent>
                 <div className="p-6">
